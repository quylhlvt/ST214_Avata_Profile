package com.avatar.ocmaker.profile.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.avatar.ocmaker.profile.utils.share.whatsapp.StickerContentProvider";
