...
import com.avatar.ocmaker.profile.ui.permision.PermissionViewModel
import com.avatar.ocmaker.profile.ui.view.ViewActivity
import com.avatar.ocmaker.profile.utils.CONST
import com.avatar.ocmaker.profile.utils.DataHelper
import com.avatar.ocmaker.profile.utils.DataHelper.dp
import com.avatar.ocmaker.profile.utils.DataHelper.getData
import com.avatar.ocmaker.profile.utils.DataHelper.setMargins
import com.avatar.ocmaker.profile.utils.PermissionHelper
...
import com.avatar.ocmaker.profile.utils.onClick
import com.avatar.ocmaker.profile.utils.onClickCustom
import com.avatar.ocmaker.profile.utils.onSingleClick
import com.avatar.ocmaker.profile.utils.saveFileToExternalStorage
import com.avatar.ocmaker.profile.utils.scanMediaFile
import com.avatar.ocmaker.profile.utils.share.telegram.TelegramSharing
import com.avatar.ocmaker.profile.utils.share.whatsapp.IdGenerator
import com.avatar.ocmaker.profile.utils.share.whatsapp.StickerBook
import com.avatar.ocmaker.profile.utils.share.whatsapp.StickerPack
import com.avatar.ocmaker.profile.utils.share.whatsapp.WhatsappSharingActivity
import com.avatar.ocmaker.profile.utils.show
import com.avatar.ocmaker.profile.utils.showDialogNotifiListener
...
import com.avatar.ocmaker.profile.databinding.ActivityMyCreationBinding
        ...
        AvatarAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvAvatar.setMargins(16.dp(this@MyCreationActivity),6.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),50)
                        checkLongClick = true
        ...
        DesignAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvDesign.setMargins(16.dp(this@MyCreationActivity),6.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),50)
                        checkLongClick = true
                        this@MyCreationActivity.checkLongClick = true
                        if (arrCheckTick.indexOf(pos) > -1) {
                            arrCheckTick.remove(pos)
    ...
    private fun getUrisFromPathsTelegram(
        ...
        paths.forEachIndexed { index, path ->
            try {
                ...
                // Đọc bitmap
                val bitmap =
                    BitmapFactory.decodeFile(originalFile.absolutePath) ?: return@forEachIndexed
                ...
                val cacheFile =
                    File(context.cacheDir, "telegram_${System.currentTimeMillis()}_$index.png")
