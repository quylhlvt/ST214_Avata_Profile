...
import com.catcreator.catmaker.meme.databinding.ActivityCategoryBinding
...
class CategoryActivity : AbsBaseActivity<ActivityCategoryBinding>() {
    ...
    override fun initView() {
        ...
        if (DataHelper.arrBlackCentered.size <= 4 && !isInternetAvailable(this@CategoryActivity)) {
            DialogExit(
